...
echo ""
echo "Released $TAG"
echo "  GitHub: https://github.com/Inflect-Labs/dart-digest/releases/tag/$TAG"
echo "  Vercel: https://vercel.com/inflectlabs/dart-digest"
echo "  Install: curl -fsSL https://dart-digest-inflectlabs.vercel.app/install | sh"
